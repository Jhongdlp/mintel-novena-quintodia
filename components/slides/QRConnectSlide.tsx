...
export default function QRConnectSlide({ onNext }: SlideProps) {
  return (
    <div className="h-full w-full flex items-center justify-center p-6 md:p-12 relative overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-red-50 via-white to-green-50 opacity-80" />
      ...
      <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
        ...
        >
          <div className="relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-red-600 to-green-500 rounded-3xl blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200" />
            <div className="relative bg-white p-4 md:p-8 rounded-3xl shadow-2xl border border-red-50">
              <img 
              ...
              <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur rounded-full p-2 shadow-sm">
                <ScanLine className="w-6 h-6 text-red-600 animate-pulse" />
              </div>
            </div>
          </div>
          <p className="mt-6 text-red-800/60 font-medium flex items-center gap-2 text-sm md:text-base">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-serif font-bold text-red-800 mb-6 leading-tight">
            Bienvenido al <span className="text-green-700">Quinto Día</span> de la Novena
          </h2>
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 bg-gradient-to-r from-red-900 to-red-800 text-white rounded-full font-bold text-lg hover:shadow-xl transition-all flex items-center gap-3 mx-auto md:mx-0 border border-red-700"
          >
